...
// [SELFHOST PATCH] URLs de imágenes de fondo para presentaciones generadas con AI.
// Configura window.__GD_DOCS_ASSET_BASE_URL__ para usar tu propio servidor de assets.
const _PPT_ASSET_BASE: string = (() => {
  try {
    const override = (globalThis as Record<string, unknown>)['__GD_DOCS_ASSET_BASE_URL__'];
    ...
    images: await getImages(
      {
        ...
        background: () =>
          `${_PPT_ASSET_BASE}/ppt-images/background/basic_2_selection_background.png`,
      },
      template
    ),
    content: template,
    ...
    images: await getImages(
      {
        ...
        background: () =>
          `${_PPT_ASSET_BASE}/ppt-images/background/basic_3_selection_background.png`,
      },
      template
    ),
    content: template,
    ...
    images: await getImages(
      {
        ...
        background: () =>
          `${_PPT_ASSET_BASE}/ppt-images/background/basic_4_selection_background.png`,
      },
      template
    ),
    content: template,
