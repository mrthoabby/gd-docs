...
export class ServerConfigResolver {
  ...
  async availableUpgrade(): Promise<ReleaseVersionType | null> {
    // [SELFHOST PATCH] Check de actualizaciones desactivado.
    // El original hacía GET a https://affine.pro/api/worker/releases
    // enviando datos de la instalación a servidores externos.
    // Las actualizaciones deben gestionarse manualmente con:
