...
// [SELFHOST PATCH] URLs de fuentes para el renderer Typst (exportación de documentos).
// Configura window.__GD_DOCS_FONT_BASE_URL__ para usar tu propio servidor de fuentes.
const _TYPST_FONT_BASE: string = (() => {
  try {
...
export const DEFAULT_TYPST_FONT_URLS = [
  `${_TYPST_FONT_BASE}/fonts/Inter-Regular.woff`,
  `${_TYPST_FONT_BASE}/fonts/Inter-SemiBold.woff`,
  `${_TYPST_FONT_BASE}/fonts/Inter-Italic.woff`,
  `${_TYPST_FONT_BASE}/fonts/Inter-SemiBoldItalic.woff`,
  `${_TYPST_FONT_BASE}/fonts/SarasaGothicCL-Regular.ttf`,
] as const;
