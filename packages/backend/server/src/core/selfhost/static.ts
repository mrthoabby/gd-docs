...
export class StaticFilesResolver implements OnModuleInit {
  ...
  onModuleInit() {
    ...
    // [SELFHOST PATCH] /admin/root ya NO necesita handler propio.
    // La ruta es manejada por el SPA React del admin (selfhost.html).
    // La autenticación y verificación de rol se hacen en el componente React (AuthenticatedRoutes).
