...
// El host se determina por AFFINE_SERVER_HOST (ej: "docs.tudominio.com") o localhost si no está configurado.
const TRUSTED_ATTACHMENT_HOST_SUFFIXES = [process.env['AFFINE_SERVER_HOST'] ?? 'localhost'];
