...
// [SELFHOST PATCH] En modo self-hosted no hay servidor de licencias:
// memberLimit se eleva a 99999 para que equipos de cualquier tamaño puedan colaborar.
// seatQuota: 1 TB por miembro (prácticamente ilimitado para self-hosted).
const TeamFeature = {
  type: FeatureType.Quota,
  configs: {
    name: 'Team Workspace',
