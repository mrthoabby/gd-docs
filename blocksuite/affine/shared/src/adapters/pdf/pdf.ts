...
// [SELFHOST PATCH] URLs de fuentes para exportación PDF configurables.
// Configura window.__GD_DOCS_FONT_BASE_URL__ para apuntar a tu propio servidor de fuentes.
const PDF_FONT_BASE: string = (() => {
  try {
...
pdfMake.fonts = {
  Inter: {
    normal: `${PDF_FONT_BASE}/fonts/Inter-Regular.woff`,
    bold: `${PDF_FONT_BASE}/fonts/Inter-SemiBold.woff`,
    italics: `${PDF_FONT_BASE}/fonts/Inter-Italic.woff`,
    bolditalics: `${PDF_FONT_BASE}/fonts/Inter-SemiBoldItalic.woff`,
  },
  SarasaGothicCL: {
    normal: `${PDF_FONT_BASE}/fonts/SarasaGothicCL-Regular.ttf`,
    bold: `${PDF_FONT_BASE}/fonts/SarasaGothicCL-Regular.ttf`,
    italics: `${PDF_FONT_BASE}/fonts/SarasaGothicCL-Regular.ttf`,
    bolditalics: `${PDF_FONT_BASE}/fonts/SarasaGothicCL-Regular.ttf`,
  },
};
