...
const getMenuItems = (t: ReturnType<typeof useI18n>) => [
  {
    label: t['com.affine.team.invite.expiration-date']({
      number: '1',
    }),
...
export const LinkInvite = ({
  ...
  const expireTime = useMemo(() => {
    return t['com.affine.team.invite.expire-at']({
    ...
    <>
      <div className={styles.invitationLinkContainer}>
        <div className={styles.modalSubTitle}>
          {t['com.affine.team.invite.link-expiration']()}
        </div>
        {invitationLink ? (
          <Input
            value={expireTime}
      ...
      <div className={styles.invitationLinkContainer}>
        <div className={styles.modalSubTitle}>
          {t['com.affine.team.invite.invitation-link']()}
        </div>
