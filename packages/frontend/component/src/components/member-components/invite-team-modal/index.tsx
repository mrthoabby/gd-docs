...
export const InviteTeamMemberModal = ({
  ...
  return (
    <ConfirmModal
      ...
      title={t['com.affine.workspace.members.team.invite.title']()}
      ...
      confirmText={
        inviteMethod === 'email'
          ? t['com.affine.workspace.members.team.invite.send-invites']()
          : t['com.affine.workspace.members.team.invite.done']()
      }
