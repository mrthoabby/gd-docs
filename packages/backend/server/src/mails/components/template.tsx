  ...
  return (
    <Html>
      ...
      <Body style={{ backgroundColor: '#f6f7fb', overflow: 'hidden' }}>
        ...
        >
          {/* [SELFHOST PATCH] Logo de email reemplazado — sin dependencia de cdn.affine.pro.
              Logo en texto para evitar imágenes externas que puedan rastrear apertura de emails. */}
          <Section>
